...
public class GameMapper {
    ...
    public static GamePhaseDTO toGamePhaseDTO(Category category, String title, String message, boolean skippable, boolean gameEnd, List<Choice> choices) {
        return new GamePhaseDTO(category.name(), title, message, skippable, gameEnd, choices.stream().map(GameMapper::toGameChoiceShortDTO).toList());
    }
